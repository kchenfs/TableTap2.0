  ...
  return (
    <>
      <header style={{
        ...
        {/* Left: kanji logo mark */}
        <div style={{
          width: '36px', height: '36px', borderRadius: '10px',
          background: 'var(--gold)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          fontFamily: 'var(--font-cormorant), serif',
          fontSize: '18px', fontWeight: 600, color: '#0e0e0e',
          flexShrink: 0,
        }}>
          桃
        </div>

        {/* Center: brand name — always visible on all screen sizes */}
        <div style={{
      ...
      {/* Search bar — expands below header when open */}
      {searchOpen && (
